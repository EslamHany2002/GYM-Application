        ...
        children: [
          ...
          SizedBox(
            ...
            child: ListView.builder(
                itemCount: carttt.selectedFoodProducts.length,
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                              ...
                              child: Image.asset(carttt.selectedFoodProducts[index].image,)),
                          SizedBox(width: 10,),
                          Column(
                            children: [
                              SizedBox(height: 20,),
                              Text(carttt.selectedFoodProducts[index].title),
                              SizedBox(height: 5,),
                              Text("Price : ${carttt.selectedFoodProducts[index].price}"),
                            ],
                          ),
                          SizedBox(width: 125,),
                          Column(
                            children: [
                              ...
                              IconButton
                                (
                                onPressed: (){
                                  carttt.remove2(carttt.selectedFoodProducts[index]);
                                  },
